...
Namespace DAL.TimeCore
    Public Class ConnectionHelper
        Shared persistentTypes As Type() = New Type() {
            GetType(WorkTimeSlot),
            GetType(TimeTable),
            GetType(TimeTableDetail),
            GetType(User),
            GetType(TimeTableAffectation),
            GetType(Department),
            GetType(DepartmentUser),
            GetType(WorkBreak)
        }
        ...
        Public Shared ReadOnly Property ConnectionString() As String
            Get
                Return System.Configuration.ConfigurationManager.ConnectionStrings("(localdb)mssqllocaldbTimeCore").ConnectionString
            End Get
        End Property
